...
import { Edit, Trash2, Plus, ExternalLink, Eye, Layout, Clock, TrendingUp, Sparkles } from 'lucide-react';
...
export const MyArticles = () => {
    ...
    const stats = [
        ...
        { label: 'إجمالي المشاهدات', value: articles?.reduce((acc, curr) => acc + curr.views_count, 0).toLocaleString('ar-EG', { numberingSystem: 'latn' }) || 0, icon: Eye, color: 'text-blue-600' },
        { label: 'معدل التفاعل', value: '24%', icon: TrendingUp, color: 'text-blue-600' }
    ];
                    ...
                    {!isLoading && articles?.length === 0 && (
                        <div className="py-32 text-center space-y-8 bg-white">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-gray-500 font-medium italic max-w-sm mx-auto">شارك أفكارك الملهمة مع آلاف القراء في مجتمع نبض.</p>
                            </div>
