                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <aside className="hidden lg:block lg:col-span-3 sticky top-24 h-fit space-y-6">
                        ...
                        <footer className="px-6 text-[10px] text-gray-400 font-bold space-x-reverse space-x-3">
                            <Link to="/about" className="hover:text-gray-900">حول نبض</Link>
                            ...
                            <p className="mt-4">© 2026 نبض - جميع الحقوق محفوظة</p>
                        </footer>
                    </aside>
                    ...
                    <aside className="hidden lg:block lg:col-span-3 sticky top-24 h-fit space-y-6">
                        ...
                        <div className="bg-[#1e293b] rounded-3xl p-8 relative overflow-hidden group">
                            <div className="relative z-10 space-y-5">
                                ...
                                <h3 className="text-xl font-black text-white leading-tight">كن جزءاً من <span className="text-blue-400 underline decoration-2 underline-offset-4">نبض</span> المعرفة</h3>
                                ...
                                <Link to={isAuthenticated ? "/editor" : "/register"} className="block w-full text-center py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-black text-sm transition-all shadow-xl shadow-blue-500/20 active:scale-95">
                                    ابدأ الآن
                                </Link>
                            </div>
