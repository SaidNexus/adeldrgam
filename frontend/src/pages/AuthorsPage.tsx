                ...
                <header className="mb-20 space-y-8">
                    <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12">
                        <div className="space-y-6 max-w-3xl">
                            ...
                            >
                                التقي بالعقول التي تثري المحتوى العربي، وتابع أقلامك المفضلة لتصلك أحدث نبضاتهم.
                            </motion.p>
                        </div>
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center text-center space-y-6">
                ...
                <div className="relative">
                    <div className="h-32 w-32 rounded-[2rem] bg-gray-50 border border-gray-100 p-1.5 overflow-hidden group-hover:border-blue-100 transition-colors">
                    ...
                    {author.role === 'admin' && (
                        <div className="absolute -bottom-1 -right-1 h-8 w-8 bg-blue-600 text-white rounded-xl flex items-center justify-center border-4 border-white shadow-lg">
                ...
                <div className="space-y-2 w-full">
                    <h3 className="text-2xl font-black text-gray-900 group-hover:text-blue-600 transition-colors truncate px-2">
