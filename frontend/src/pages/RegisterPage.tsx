...
import { Loader2, UserPlus, Sparkles, ChevronRight } from 'lucide-react';
...
export const RegisterPage = () => {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.message || 'حدث خطأ غير متوقع أثناء تكوين هويتك');
        } finally {
            setLoading(false);
        }
    };
            ...
            >
                <div className="bg-white border border-gray-200 p-10 md:p-16 rounded-[3rem] shadow-xl shadow-gray-200/50 space-y-12">
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <h2 className="text-3xl md:text-4xl font-black text-gray-900">انضم لنبض</h2>
                    ...
                    <form className="space-y-8" onSubmit={handleRegister}>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label htmlFor="fullName" className="block text-[10px] font-black text-gray-400 uppercase tracking-widest px-1">الاسم الكامل</label>
                                <input
                                    id="fullName"
                                    type="text"
                                    required
                            ...
                            <div className="space-y-2">
                                <label htmlFor="username" className="block text-[10px] font-black text-gray-400 uppercase tracking-widest px-1">اسم المستخدم</label>
                                <input
                                    id="username"
                                    type="text"
                                    required
                            ...
                            <div className="space-y-2 md:col-span-2">
                                <label htmlFor="email" className="block text-[10px] font-black text-gray-400 uppercase tracking-widest px-1">البريد الإلكتروني</label>
                                <input
                                    id="email"
                                    type="email"
                                    required
                            ...
                            <div className="space-y-2 md:col-span-2">
                                <label htmlFor="password" className="block text-[10px] font-black text-gray-400 uppercase tracking-widest px-1">مفتاح العبور</label>
                                <input
                                    id="password"
                                    type="password"
                                    required
