...
export const ArticleCard = ({ article }: ArticleCardProps) => {
    ...
    return (
        <motion.div
            ...
            className="group bg-white border border-[#e2e8f0] rounded-[1.5rem] overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 font-almarai"
        >
            {/* Header: Author Info */}
            <div className="p-4 md:p-5 flex items-center justify-between border-b border-[#f1f5f9] bg-white/50">
            ...
            <Link to={`/articles/${article.slug}`} className="block group/content">
                <div className="px-5 py-4">
                    <h3 className="text-xl md:text-2xl font-black text-[#0f172a] leading-[1.3] group-hover/content:text-blue-600 transition-colors">
                        {article.title}
                    </h3>
                    {article.excerpt && (
            ...
            {/* Footer: Action Bar */}
            <div className="px-3 py-2 border-t border-[#f1f5f9] flex items-center justify-between bg-[#f8fafc]/30">
