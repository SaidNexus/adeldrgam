...
from app.core.security import verify_password, get_password_hash, get_current_user, get_current_active_superuser
...
def list_users(
    ...
    """Fallback users endpoint to prevent 404 on /api/v1/users/"""
    from app.api.admin import list_all_users
    return list_all_users(session=session, current_user=current_user, search=None, limit=100, offset=0)
